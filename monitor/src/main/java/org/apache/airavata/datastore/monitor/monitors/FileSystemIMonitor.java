...
public class FileSystemIMonitor implements IMonitor {

    private final Logger logger = LogManager.getLogger(FileSystemIMonitor.class);
    ...
    public FileSystemIMonitor(Path dir) throws IOException {
