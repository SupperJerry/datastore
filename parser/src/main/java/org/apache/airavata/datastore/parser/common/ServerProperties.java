package org.apache.airavata.datastore.parser.common;
...
public class ServerProperties {
    ...
    public static final String SERVER_PROPERTY_FILE = "../conf/parser.properties";
    public static final String DEFAULT_SERVER_PROPERTY_FILE = "conf/parser.properties";
    ...
    private InputStream getServerPropertiesURL() throws Exception {
        ...
        // load parser.properties from conf directory.
